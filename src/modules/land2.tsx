...
const App: React.FC = () => {
  ...
  return (
    <Layout className="min-h-screen">
      <Header className="bg-white shadow-md px-8 flex items-center justify-between h-20 sticky top-0 z-30">
        <div className="flex items-center">
          ...
          <div className="hidden lg:flex">
            <a
              href="https://readdy.ai/home/be1ad4ae-35c8-469d-bc6c-b0b56d11bffd/a4e1df5e-b038-4ba2-b8d6-e8b39adbdede"
              data-readdy="true"
              className="px-4 py-2 text-gray-800 hover:text-purple-700 cursor-pointer"
            >
              Home
            </a>
            <a className="px-4 py-2 text-gray-800 hover:text-purple-700 cursor-pointer">
              About
            </a>
            <a
              href="https://readdy.ai/home/be1ad4ae-35c8-469d-bc6c-b0b56d11bffd/27a18da7-882d-4d16-81cb-c1a1ab8692b2"
              data-readdy="true"
              className="px-4 py-2 text-gray-800 hover:text-purple-700 cursor-pointer"
            >
              Courses
            </a>
            <a className="px-4 py-2 text-purple-700 font-medium border-b-2 border-purple-700 cursor-pointer">
              Admissions
            </a>
            <a className="px-4 py-2 text-gray-800 hover:text-purple-700 cursor-pointer">
              Research
        ...
        <div className="flex items-center">
          <a
            href="https://readdy.ai/home/be1ad4ae-35c8-469d-bc6c-b0b56d11bffd/a4e1df5e-b038-4ba2-b8d6-e8b39adbdede"
            data-readdy="true"
            className="flex items-center text-gray-600 hover:text-purple-700 mr-6 cursor-pointer"
          >
            <ArrowLeftOutlined className="mr-1" /> Back to Main Site
          </a>
          <Button
            type="default"
      ...
      <Content className="bg-gray-100 min-h-[1024px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              ...
              <div>
                ...
                <Paragraph className="text-gray-600">
                  ...
                  4-6 weeks. You'll receive updates via email about your
                  application status.
                </Paragraph>
              </div>
              <div>
              ...
              <div>
                ...
                <Paragraph className="text-gray-600">
                  Yes, there is a non-refundable application fee of $50 USD.
      ...
      <style jsx global>{`
.application-steps .ant-steps-item-process .ant-steps-item-icon {
background-color: #4338ca;
border-color: #4338ca;
}
.application-steps .ant-steps-item-finish .ant-steps-item-icon {
background-color: #fff;
border-color: #4338ca;
}
.application-steps .ant-steps-item-finish .ant-steps-item-icon .ant-steps-icon {
color: #4338ca;
}
.application-steps .ant-steps-item-finish > .ant-steps-item-container > .ant-steps-item-content > .ant-steps-item-title::after {
background-color: #4338ca;
}
`}</style>
    </Layout>
