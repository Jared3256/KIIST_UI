      ...
      <Header className='bg-white shadow-md px-8 flex items-center justify-between h-20 sticky top-0 z-30'>
        <div className='flex items-center'>
          ...
          <div className='hidden lg:flex'>
            <a
              href='#'
              className='px-4 py-2 text-gray-800 hover:text-blue-700 cursor-pointer'>
              Home
            </a>
            <a
              href='#'
            ...
            <a
              href='#'
              className='px-4 py-2 text-blue-700 font-medium border-b-2 border-blue-700 cursor-pointer'>
              Courses
            </a>
            <a
              href='#'
        ...
        <div className='flex items-center'>
          <a
            href='https://readdy.ai/home/be1ad4ae-35c8-469d-bc6c-b0b56d11bffd/e4559866-d28f-4e4d-9d51-ebb891069f18'
            data-readdy='true'
            className='flex items-center text-gray-600 hover:text-blue-700 mr-6 cursor-pointer'>
