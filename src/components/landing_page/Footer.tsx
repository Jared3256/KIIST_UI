                    ...
                    <Row gutter={[48, 32]}>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex flex-col space-y-2 text-gray-400">
                                    <div className="flex items-center">
                                        <EnvironmentOutlined className="mr-2"/> Kisii Town - Twin Towers
                                    </div>
                                    <div className="flex items-center">
                                        <PhoneOutlined className="mr-2"/> +254 784 663693
                                    </div>
                                    <div className="flex items-center">
                                        <MailOutlined className="mr-2"/> admissions@kisii.ac.ke
                                    </div>
                                </div>
                            </div>
                        </Col>
                        ...
                        <Col xs={24} md={6}>
                            ...
                            <div className="flex space-x-4 mb-6">
                                ...
                                <a
                                    href="https://www.facebook.com/kiistofficial"
                                    target={"_blank"}
