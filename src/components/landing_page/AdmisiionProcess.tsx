...
export default function AdmisiionProcess() {
    ...
    return (
        <Content>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="relative overflow-hidden rounded-lg shadow-md group h-64 cursor-pointer">
                            ...
                            <div
                                ...
                                <div className="text-center text-blue-950 p-4">
                        ...
                        <div
                            className="relative overflow-hidden rounded-lg shadow-md group h-64 cursor-pointer md:col-span-2">
                            <img
            ...
            {/* Admission Process */}
            <section className="py-16 bg-blue-900 text-blue-950">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                    ...
                    <div className="bg-white/10 rounded-xl p-8 backdrop-blur-sm">
                        <Timeline mode="alternate" className="admission-timeline">
                            <Timeline.Item
                                dot={
                                    <div
                                        className=" rounded-full text-blue-950 w-8 h-8 flex items-center justify-center">
                                        1
                                    </div>
                                }
                            >
                            ...
                            <Timeline.Item
                                dot={
                                    <div
                                        className=" text-blue-950 w-8 h-8 rounded-full flex items-center justify-center">
                                        2
                                    </div>
                                }
                            >
