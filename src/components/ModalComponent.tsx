                ...
                return (
                    <div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            <div>
                                <Text strong>Department: </Text>
                                <Text>{selectedItem?.departmentName}</Text>
                            </div>
                            <div>
                        ...
                        <List
                            itemLayout='horizontal'
                            dataSource={selectedItem.courses.units}
                            renderItem={(item) => (
                                <List.Item>
                                    <List.Item.Meta
                                        avatar={<Avatar icon={<BookOutlined/>}/>}
                ...
                return (
                    <Form
                        ...
                        <Form.Item name='lecturer' label='Lecturer'>
                            <Input disabled value={selectedItem._id}/>
                        </Form.Item>
