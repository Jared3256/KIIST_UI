            ...
            <Card title='Quick Actions' className='h-full shadow-md'>
              <div className='space-y-3'>
                ...
                <Button
                  block
                  className='text-left h-auto py-3 flex items-center !rounded-button whitespace-nowrap cursor-pointer'>
                  <MailOutlined className='mr-2' /> Contact Finance Office
                </Button>
                <Button
                  block
                  className='text-left h-auto py-3 flex items-center !rounded-button whitespace-nowrap cursor-pointer'>
                  <PrinterOutlined className='mr-2' /> Print Statement
                </Button>
                <Button
                  type='primary'
                  block
                ...
                <Card title='Saved Payment Methods'>
                  <div className='mb-6'>
                    <Row gutter={[24, 24]}>
                      ...
                      <Col xs={24} md={8}>
                        <Card className='border border-dashed border-gray-300 hover:shadow-md transition-shadow text-center py-10 cursor-pointer'>
