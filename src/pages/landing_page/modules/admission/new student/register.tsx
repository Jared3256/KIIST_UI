                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                  <div className="mb-6 md:mb-0">
                    ...
                    <div className="flex flex-col space-y-2 text-gray-400">
                      <div className="flex items-center">
                        <EnvironmentOutlined className="mr-2" /> Twin Towers, Kisii, Kenya
                      </div>
                      <div className="flex items-center">
                  ...
                  <div className="text-center md:text-right">
                    <div className="mb-4">
                      <Title level={5} className="text-white m-0" style={{
                        color:"white"
                      }}>
                        Connect With Us
                      </Title>
                    ...
                    <Link to={"/"} className="text-blue-400 hover:text-blue-300 cursor-pointer"> Return to Main Website</Link>
