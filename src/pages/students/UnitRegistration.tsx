...
import {Alert, Typography, Button, Card, Input, Select, Space, Table, Tag, message} from "antd";
...
import {dataToCourse, dataToDepartment, dataToUnits} from "src/modules/Data.format.ts";
...
export default function UnitRegistration() {
    ...
    const handleRegisterCourse = async (course: any) => {
