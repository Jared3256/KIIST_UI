                            ...
                            renderItem={(item) => (
                                    ...
                                    actions={[
                                        item.type === "cat" ? (
                                            <Button
                                                ...
                                                disabled={!isCatAvailable(item)}
                                                className="!rounded-button whitespace-nowrap"
                                            >
                                                {isCatAvailable(item) ? "Start CAT" : "Not Available"}
                                            </Button>
                                        ) : (
                                            <Button
                                                type="primary"
                                ...
                                >
                                            ...
                                            <Space direction="vertical">
                                                ...
                                                {item.type === "cat" &&
                                                    ...
                                                    item.endTime && (
                                                        <Text>
                                                            Available:{" "}
                                                            {formatTimeWindow(item.startTime, item.endTime)}
                                                        </Text>
                                                    )}
                                    ...
                                    <div>
                                        ...
                                        {item.type === "cat" && (
                                            <Tag color={isCatAvailable(item) ? "green" : "orange"}>
                                                {isCatAvailable(item)
                                                    ? "Available Now"
                                                    : "Not Available"}
                                            </Tag>
